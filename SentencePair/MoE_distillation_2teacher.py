...
from SentencePair.arguments_2teacher import get_args
from SentencePair.MoE_distiller_2teacher import Distiller
from SentencePair.data_utils.distill_datasets_2teacher import DistillDataset
...
def prepare_dataset(args, distiller):
    ...
    if args.do_train:
        data["train"] = DistillDataset(
            ...
            distiller.teacher_tokenizers, distiller.teacher_tokenizers_2
        )
