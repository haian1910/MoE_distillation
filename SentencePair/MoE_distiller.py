...
class GatingNetwork(nn.Module):
    ...
    def __init__(self, input_dim, num_experts, hidden_dim=768):
...
class MoELayer(nn.Module):
    ...
    def __init__(self, input_dim, output_dim, num_experts=3, expert_hidden_dim=768):
...
class MoEDistilledBERT(nn.Module):
    ...
    def __init__(self, bert_model, teacher_hidden_size, num_experts=3, expert_hidden_dim=768):
...
class Distiller(nn.Module):
    ...
    def add_distiller_args(parser):
        ...
        group.add_argument("--expert-hidden-dim", type=int, default=768,
    ...
    def load_student_model(self):
        ...
        if self.args.peft is not None: #for LLM2Vec
            ...
            model = MoEDistilledBERT(
                ...
                expert_hidden_dim=getattr(self.args, 'expert_hidden_dim', 768)
            )
