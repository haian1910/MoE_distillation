...
CKPT_NAME="bert_patent_2tea"
CKPT_PATH="${BASE_PATH}/model_hub/${CKPT_NAME}"
TEACHER_MODEL_NAME="LLM2Vec"
TEACHER_MODEL_PATH="/content/drive/MyDrive/Colab_Notebooks/data_distillation/checkpoint_for_test/Llama_sft_patent" # checkpoint LLM2Vec Mistral 7B
TEACHER_MODEL_2_PATH="/content/drive/MyDrive/Colab_Notebooks/data_distillation/checkpoint_for_test/Qwen_0.6B_embedding_patent" #checkpoint Qwen 0.6B embedding
# data
...
CMD="torchrun ${DISTRIBUTED_ARGS} ${BASE_PATH}/Classification/MoE_distillation_2teacher.py ${OPTS}"
