...
TEACHER_MODEL_PATH="link checkpoint" # GẮN LINK MODEL CHECKPOINT VÀO ĐÂY
# data
DATA_DIR="/content/drive/MyDrive/Colab_Notebooks/data_distillation/llm2vec_distill/nfcorpus"
# task
TASK="uld"
# hp
BATCH_SIZE=16
