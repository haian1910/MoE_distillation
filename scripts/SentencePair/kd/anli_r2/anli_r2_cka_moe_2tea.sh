...
TEACHER_MODEL_2_PATH="/content/drive/MyDrive/Colab_Notebooks/data_distillation/checkpoint_for_test/Qwen_0.6B_embedding_anli_r2" #checkpoint Qwen 0.6B embedding
# data
DATA_DIR="/content/drive/MyDrive/Colab_Notebooks/data_distillation/data_test/anli_r2"
NUM_LABELS=3
# task
TASK="cka_moe_2tea"
# hp
