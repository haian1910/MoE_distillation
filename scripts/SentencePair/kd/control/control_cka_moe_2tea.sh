...
CKPT_NAME="bert_control_2tea"
CKPT_PATH="${BASE_PATH}/model_hub/${CKPT_NAME}"
TEACHER_MODEL_NAME="LLM2Vec"
TEACHER_MODEL_PATH="/content/drive/MyDrive/Colab_Notebooks/data_distillation/checkpoint_for_test/Llama_sft_control" # checkpoint LLM2Vec Mistral 7B
TEACHER_MODEL_2_PATH="/content/drive/MyDrive/Colab_Notebooks/data_distillation/checkpoint_for_test/Qwen_0.6B_embedding_control" #checkpoint Qwen 0.6B embedding
# data
DATA_DIR="/content/drive/MyDrive/Colab_Notebooks/data_distillation/data_test/control"
NUM_LABELS=3
# task
TASK="cka_moe_2tea"
# hp
