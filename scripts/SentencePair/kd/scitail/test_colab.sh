...
TEACHER_MODEL_PATH="/content/drive/MyDrive/2MMath/data_distillation/checkpoint_for_test/Llama_sft_scitail"
# data
DATA_DIR="/content/MoE_distillation/data/scitail_30"
NUM_LABELS=2
# task
TASK="moo"
# hp
